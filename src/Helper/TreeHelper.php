...
class TreeHelper
{
     ...
     * @param mixed $title
     */
    public static function _toFormatTree($list, $level = 0, $title = 'title')
    {
    ...
    {
        $list             = self::list_to_tree($list, $pk, $pid, '_child', $root, $strict);
        self::$formatTree = [];
     ...
     * @return array
     */
    public static function list_to_tree($list, $pk = 'id', $pid = 'pid', $child = '_child', $root = 0, $strict = true)
    {
        // 创建Tree
        $tree = [];
        if (is_array($list)) {
